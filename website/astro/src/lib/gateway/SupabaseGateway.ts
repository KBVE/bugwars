...
import { detectCapabilities, selectStrategy, logCapabilities, getStrategyDescription } from './capabilities';
...
export class SupabaseGateway implements ISupabaseStrategy {
  ...
  constructor() {
    ...
    console.log(`[SupabaseGateway] Selected strategy: ${getStrategyDescription(this.strategyType)}`);
